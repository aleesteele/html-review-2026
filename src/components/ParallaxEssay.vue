...
const rawParagraphs = [
  ...
  `I came back to these myths of my childhood again when I started researching how to walk across the {{Baekdudaegan|image:/images/baekdudaegan.jpg|note:백두대간 — The main mountain ridge of the Korean peninsula, stretching roughly 1,500km from Baekdusan in the north to Hallasan in the south.}}.`,

  `The Baekdudaegan is a mountain range that is as much a product of mythology as it is of geology, roughly 1,500 kilometers across the Korean peninsula. It starts at Baekdusan, an active volcano that sits on the border of what is now known as the Democratic Republic of Korea (North Korea) and China. After curving down the peninsula, the range ends at {{Hallasan|image:/images/hallasan.png|note:한라산 — A shield volcano and the highest peak in South Korea (1,950m), located on Jeju Island.}} on Jeju Island, a dormant volcano that sits on what's known as the "Hawaii of Korea", the home of the legendary {{hanyeo|note:해녀 — Female free-divers of Jeju Island, recognized by UNESCO as Intangible Cultural Heritage. They dive without oxygen tanks to harvest seafood.}}. These two mountains sit at the heart of Korean mythology, with Baekdusan the father and Hallasan the mother cradling both sides of the peninsula in some kind of protective embrace.`,
  ...
  `I learned about the sanshin – which roughly translates to mountain spirit – from {{David Mason|note:An American scholar based in South Korea who has spent decades documenting sanshin shrines and mountain worship traditions across the peninsula.|link:https://san-shin.net}}, a scholar who's been tracking their worship across Korea for decades now. He is, in many ways, the kind of brash yet benevolent Orientalist that taught me in college, a product of 1960s counterculture and Alan Watts that spawned many an East Asian Studies scholar. The sanshin encapsulates the living relationship that Koreans have with their mountains, interspersed with discussions about where energy flows, and how it strengthens in mountain air.`,

  `Maybe my tether to Korea lies in the mountains, as I've always been searching for an entry-point into a culture that never felt quite like mine to claim. My own relationship to my motherland is tenuous at best. Although my parents ironically now live in {{one of the largest Korean enclaves in the US|note:Annandale, Virginia is census-designated place in Fairfax County, Virginia, known as "Koreatown" for its large Korean-American community and concentration of Korean businesses.}}, for years we moved around whitewashed suburbs near Chicago, Washington DC, Atlanta, and Houston. Growing up, we oscillated between visiting our German-American side on the {{beaches of New Jersey}} and the Korean-American side on the {{beaches of California}}. The Stop Asian Hate movement put a thermometer to the melting pot of my childhood.`,
