...
const rawParagraphs = [
  ...
  `That's not to say that I've always been like this. My suburban childhood predictably led to an urban adulthood. I came of age in {{global cities|image:/images/global-cities.png|note:In her classic 1991 book, Saskia Sassen coined the term 'Global City' to describe how New York, London, and Tokyo were becoming command centers of the global economy during what was the emerging pe. I worked for her for a year during undergrad.}}: New York City for university, Los Angeles and Madrid for two different summers in college, Washington DC for my first job, Geneva for graduate school, London for another job. Most of my friends would call me a {{"city mouse"|note:"The Town Mouse and the Country Mouse" is one of Aesop's Fables, and has been adopted for many children's books.}}, especially in comparison to my more traditionally mountain goat-like partner.`,

  `But even in cities, I always found myself gravitating towards the spaces where I could find breathing room: {{the roof of my apartment in Inwood|image:/images/global-cities.png|note:A neighbourhood at the northern tip of Manhattan, known for its proximity to Fort Tryon Park and the Cloisters.}}, {{the ponds of Hampstead Heath|image:/images/global-cities.png|note:A large, ancient heath in north London, known for its wild swimming ponds and panoramic city views.}}, {{the rambling hills of the lower Jura|image:/images/global-cities.png|note:A sub-Alpine mountain range stretching along the French-Swiss border near Geneva.}} that were a run away from my apartment.`,
