...
const rawParagraphs = [
  ...
  `I came back to these myths of my childhood again when I started researching how to walk across the {{Baekdudaegan|image:/images/baekdudaegan.jpg|note:백두대간 — The main mountain ridge of the Korean peninsula, stretching roughly 1,500km from Baekdusan in the north to Hallasan in the south. Image taken}}.`,

  `The Baekdudaegan is a mountain range that is as much a product of mythology as it is of geology, roughly 1,500 kilometers across the Korean peninsula. It starts at Baekdusan, an active volcano that sits on the border of what is now known as the Democratic Republic of Korea (North Korea) and China. After curving down the peninsula, the range ends at {{Hallasan|image:/images/hallasan.png|note:한라산 — A shield volcano and the highest peak in South Korea (1,950m), located on Jeju Island.}} on Jeju Island, a dormant volcano that sits on what's known as the "Hawaii of Korea", the home of the legendary {{hanyeo|note:해녀 — Female free-divers of Jeju Island, recognized by UNESCO as Intangible Cultural Heritage. They dive without oxygen tanks to harvest seafood, primarily abalone, conch, sea urchins, octopus, sea cucumbers, and types of seaweed.}}. These two mountains sit at the heart of Korean mythology, with Baekdusan the father and Hallasan the mother cradling both sides of the peninsula in some kind of protective embrace.`,
  ...
  `The Baekdudaegan has become a symbol, for obvious reasons, of Korean reunification. {{The white and blue flags|note:The XXIII Winter Olympic Games, held in Pyeongchang, South Korea. North and South Korean athletes marched together under a unified Korean flag during the opening ceremony.}} that flew at the 2018 Pyeongchang Olympics brought tears to the eyes of my whole family, as the blue rendering of the peninsula was reminiscent of a body made whole, with its mountainous spine intact. The dream of a cross-national trail remains a pipedream, especially after the breakdown of diplomatic relations in Hanoi in 2019.`,
