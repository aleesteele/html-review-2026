...
const rawParagraphs = [
  ...
  `I came back to these myths of my childhood again when I started researching how to walk across the {{Baekdudaegan|image:/images/baekdudaegan.jpg|note:백두대간 — The main mountain ridge of the Korean peninsula, stretching roughly 1,500km from Baekdusan in the north to Jirisan then Hallasan in the south. Image taken}}.`,
  ...
  `As I scroll further down, there is a sea of deep green trees, interspersed with squares of snow, a quilt of data captured at different seasons stitched together for the semblance of continuity. Scrolling further, deep in North Korea now, {{I see labels for working camps|image:|note:관리소 – North Korean political prison camps (kwanliso) have been extensively documented by human rights organisations.}}, nondescript buildings that do little to capture the unimaginable acts that take place there. Geopolitical analysts read this satellite imagery like tea leaves, trying to understand a regime that remains closed to the world more than 70 years after the Korean War.`,
