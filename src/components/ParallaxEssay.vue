...
const rawParagraphs = [
  ...
  `For me, these stories were magical illustrations of the world that once was, and it imbued nature with a magic I only started to understand when I started spending more time in mountains myself: first as a {{hiker in the Adirondacks and the Cascades|image:/images/enchantments.jpg|note:2015, The Enchantments, Cascades, Washington, USA. I broke my ankle later that day, on the descent of this hike.}}, then as a {{researcher in the Himalayas|image:/images/tigers-nest.jpg|note:Paro Taktsang, known as the Tiger’s Nest, is a sacred Buddhist monastery perched on a 3,120-meter cliffside in Bhutan's Paro Valley. Built in 1692, it marks where Guru Rinpoche is said to have meditated for three years after flying there on a tigress.}}, later a {{skier and mountaineer in the Alps|image:/images/chamonix.jpg|note:In . 2020. }}.`,
  ...
  `There's no real meaningful explanation as to why I love the mountains other than that I simply feel more alive when I'm outside. My face is more sensitive to the wind and the rain on my cheeks. My food, however disgustedly prepared, tastes more delicious at altitude. My sense of mortality seems more profound and lending of direction when I can see the world from a bird's eye view.`,

  `That's not to say that I've always been like this. My suburban childhood led to an urban adulthood. I came of age in global cities: {{New York City|note:Where Anne studied at Columbia University.}} for university, {{Los Angeles|note:America's second-largest city, on the Pacific coast of California.}} and {{Madrid|note:The capital of Spain, where Anne spent a summer during college.}} for two different summers in college, {{Washington DC|note:The US capital, where Anne held her first job.}} for my first job, {{Geneva|note:A Swiss city at the southern tip of Lake Geneva, where Anne attended graduate school.}} for graduate school, {{London|note:Where Anne currently lives and works at The Alan Turing Institute.}} for another job. Most of my friends would call me a "city mouse", especially in comparison to my more traditionally mountain goat-like partner.`,

  `But even in cities, I always found myself gravitating towards the spaces where I could find breathing room: {{the roof of my apartment in Inwood|note:A neighbourhood at the northern tip of Manhattan, known for its proximity to Fort Tryon Park and the Cloisters.}}, {{the ponds of Hampstead Heath|note:A large, ancient heath in north London, known for its wild swimming ponds and panoramic city views.}}, {{the rambling hills of the lower Jura|note:A sub-Alpine mountain range stretching along the French-Swiss border near Geneva.}} that were a run away from my apartment.`,
  ...
  `The Baekdudaegan is a mountain range that is as much a product of mythology as it is of geology, roughly 1,500 kilometers across the Korean peninsula. It starts at {{Baekdusan|note:백두산 — An active stratovolcano on the border of North Korea and China, considered the spiritual birthplace of the Korean people.}}, an active volcano that sits on the border of what is now known as the Democratic Republic of Korea (North Korea) and China. After curving down the peninsula, the range ends at {{Hallasan|note:한라산 — A shield volcano and the highest peak in South Korea (1,950m), located on Jeju Island.}} on Jeju Island, a dormant volcano that sits on what's known as the "Hawaii of Korea", the home of the legendary {{hanyeo|note:해녀 — Female free-divers of Jeju Island, recognized by UNESCO as Intangible Cultural Heritage. They dive without oxygen tanks to harvest seafood.}}. These two mountains sit at the heart of Korean mythology, with Baekdusan the father and Hallasan the mother cradling both sides of the peninsula in some kind of protective embrace.`,
  ...
  `In any case, my research soon revealed that {{this is not how Koreans "do" the Baekdudaegan at all|note:Unlike Western thru-hiking culture, Korean hikers typically complete the Baekdudaegan in sections over months, years, or even decades.}}. They do it over many months, years, even decades, stringing together long weekends sprinkled in between the few holidays that Koreans are able to take off in an infamously punishing working culture.`,

  `Life starts, or rather flows down from the rivers that begin at the Baekdudaegan, a belief descendent from the combination of Taoism and Buddhism that made its way to Korea from the joint imperial influences of China and Japan, combining to make something different: a deep, instinctual respect for mountains, and a worship of nature despite whatever wider religion may be dominant at the time. I see this reverence play out in the way all of my family best appreciate their kimchi and rice outside, and up high. {{I took a road trip up the California coast a few years ago with my uncle and aunt|note:Korean families often bond over outdoor cooking — portable gas stoves and instant noodles are essential gear for any outing.}}, and our best meals always consisted of {{shin ramen|note:신라면 — A popular brand of instant spicy noodles, a staple of Korean outdoor eating.}}, eggs, kimchi and rice, cooked under the shade of my uncle's van.`,

  `I learned about the sanshin – which roughly translates to mountain spirit – from {{David Mason|note:An American scholar based in South Korea who has spent decades documenting sanshin shrines and mountain worship traditions across the peninsula.|link:https://san-shin.net}}, a scholar who's been tracking their worship across Korea for decades now. He is, in many ways, the kind of brash yet benevolent Orientalist that taught me in college, a product of 60s counterculture and Alan Watts that spawned many an East Asian Studies scholar. The sanshin encapsulates the living relationship that Koreans have with their mountains, interspersed with discussions about where energy flows, and how it strengthens in mountain air.`,

  `Maybe my tether to Korea lies in the mountains, as I've always been searching for an entry-point into a culture that never felt quite like mine to claim. My own relationship to my motherland is tenuous at best. Although my parents ironically now live in {{one of the largest Korean enclaves in the US|note:Annandale, Virginia is census-designated place in Fairfax County, Virginia, known as "Koreatown" for its large Korean-American community and concentration of Korean businesses.}}, for years we moved around {{whitewashed suburbs|note:Predominantly white suburban communities across the American Midwest and South.}} near {{Chicago|note:Where Anne grew up, in the suburbs of Illinois.}}, {{Washington DC|note:The US capital region, where the family also lived.}}, {{Atlanta|note:The capital of Georgia, a major city in the American South.}}, and {{Houston|note:The largest city in Texas, home to a growing Korean-American community.}}. Growing up, we oscillated between visiting our German-American side on the beaches of New Jersey and the Korean-American side on the beaches of California. The Stop Asian Hate movement put a thermometer to the melting pot that shaped my childhood.`,

  `The problem is that the Korea my mother knows and remembers from her own childhood is not the one that exists now. It was only when I was a researcher in Bhutan that I started to understand this. In the mountains there, {{I found a landscape so laden with myth that I was afraid to misstep|note:Bhutan's landscape is deeply intertwined with Buddhist mythology — nearly every rock, river, and mountain has a spiritual story attached to it.}}: because there was a rock that the {{Zhabdrung|note:Zhabdrung Ngawang Namgyal — the Tibetan Buddhist lama who unified Bhutan in the 17th century. Sacred sites associated with him are found throughout the country.}} had meditated on, or because beyond that hill lay a forest full of ghosts, or a {{chorten|note:A Buddhist shrine or stupa, common throughout the Himalayas, often marking sacred sites or serving as points for circumambulation.}} that had been a pilgrimage site for centuries.`,

  `There, children played games not unlike the ones my mom told me about growing up, variations of pick-up sticks and marbles that are as much a function of poverty as they are of culture. When she returned to Korea for the first time in 30 years back in 2018, she was overwhelmed by the hyper-urbanism of Seoul, and felt rejected by the relatives that expected her to have American money she never earned. I felt more connected to my mother's Korea in the Himalayas than I did in Seoul myself, {{when I visited for the first time in 2013|note:Anne's first visit to South Korea, where the rapid modernisation felt disconnected from the Korea her mother had described.}}.`,
  ...
  `Even the Baekdusan has been a product of modern mythology, with the Kim family claiming that Kim Il Sung was born in the volcano's center. A few years ago, his grandson, {{Kim Jung Un rode a white horse|note:In 2019, Kim Jong Un was photographed riding a white horse on Mount Baekdu, echoing his father's and grandfather's mythologised connections to the mountain.}} through the same landscape to reinvigorate his claim to the "Mount Baekdu bloodline".`,

  `I spoke to a scientist who coordinates a {{cross-national research project on Mount Baekdu|note:A rare collaboration between North Korean, South Korean, British, and American scientists studying the volcano's seismic activity after signs of a potential eruption.}}, coordinating North and South Korean, British, and American scientists to investigate the tectonic movements of the holy volcano. After it showed signs of erupting in the early 2010s, international calls for disaster prevention enabled research to be done on a scale previously thought impossible. Professor {{James Hammond|note:A British geophysicist at Birkbeck, University of London, who led collaborative research with North Korean scientists studying the volcanic activity of Mount Paekdu.|link:https://www.bbk.ac.uk/our-staff/profile/8005574/james-hammond}} told me that until recently, glaciology, oceanography, and volcanology were seen as universal sciences in the sense that they knew no borders. When he became a scientist, research was seen as a form of diplomacy. Now, he says, {{it is increasingly seen as a tool for real politik|note:The politicisation of scientific research has made cross-border collaboration increasingly difficult, even in fields that transcend national boundaries.}}.`,

  `From my London flat, {{I use Google maps to trace my mouse over Mount Baekdu|note:Satellite imagery offers a way to virtually 'walk' landscapes that are physically inaccessible — though it flattens the experience.}}, the bird's eye view afforded by satellite imagery somehow flattening rather than elevating the landscape's majesty. As I {{zoom into the volcano|note:The crater lake at the summit of Baekdusan, called Heaven Lake (천지), is one of the highest crater lakes in the world.}}, a blinding white surrounds a deep blue pool, the center of the volcano that birthed both legend and modern politics.`,

  `As I scroll further down, there is a sea of deep green trees, interspersed with squares of snow, a quilt of data captured at different seasons stitched together for the semblance of continuity. Scrolling further, deep in North Korea now, {{I see labels for working camps|note:North Korean political prison camps (kwanliso) are visible in satellite imagery and have been extensively documented by human rights organisations.}}, nondescript buildings that do little to capture the unimaginable acts that take place there. Geopolitical analysts read this satellite imagery like tea leaves, trying to understand a regime that remains closed to the world more than 70 years after the Korean War.`,
  ...
  `Maybe if I eat 20 garlics and a mugwort and stay in a cave for 100 days, I too will emerge a new being. Maybe if I eat 200 ramens and walk across the Baekdudaegan, I will be a better person.`,
