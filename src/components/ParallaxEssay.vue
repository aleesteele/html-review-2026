...
const rawParagraphs = [
  ...
  `In the beginning, {{Hwanung|image:/images/hwanung.png|note:Illustration from "I love Korea!".}}, the son of Hwanin (the Sky god) so wanted to come to earth that he was sent to the peak of {{Mount Baekdu|image:/images/mt-paekdu.png|note:백두산 — Baekdusan is an active stratovolcano on the border of North Korea and China. (Google Maps, 2026).}}. As he ruled the world from a city he created at the volcano's center, a bear and tiger came to ask if they could become humans. He gave the pair a stalk of mugwort and twenty pieces of garlic, and told them that if they ate both and avoided the sunlight for one hundred days, they would become human.`,
  ...
  `For me, these stories were magical illustrations of the world that once was, and it imbued nature with a magic I only started to understand when I started spending more time in mountains myself: first as a {{hiker in the Cascades|image:/images/enchantments.jpg|note:Me on the Enchantments trail. 2015, Washington, USA. I broke my ankle later that day on the descent of this hike.}}, then as a {{researcher and mountaineer in the Himalayas|image:/images/uwicer.jpg|note:The Ugyen Wangchuck Institute for Forestry Research and Training is a Government based research and training institute in Jakar, Bhutan. Photo by Emma Greenberg, 2017.}}, later a {{skier in the Alps|image:/images/chamonix.jpg|note:On my first ski tour in front of the Refuge du Requin, on the Vallée Blanche. 2020, Chamonix, France. The first COVID-19 lockdown started the day after this photo was taken. Photo by David Littlejohn-Carrillo.}}.`,
  ...
  `That's not to say that I've always been like this. My suburban childhood predictably led to an urban adulthood. I came of age in {{global cities|image:/images/global-cities.png|note:In her classic 1991 book, sociologist Saskia Sassen coined the term 'Global City' to describe cities with outsized influence on the global economy during what was the emerging phenomena of globalisation. I worked for her for a year during undergrad.}}: New York City for university, Los Angeles and Madrid for two different summers in college, Washington DC for my first job, Geneva for graduate school, London for another job. Most of my friends would call me a {{"city mouse"|note:"The Town Mouse and the Country Mouse" is one of Aesop's Fables, and has been adopted for many children's books.}}, especially in comparison to my more traditionally mountain goat-like partner.`,

  `But even in cities, I always found myself gravitating towards the spaces where I could find breathing room: {{the roof of my apartment in Inwood|image:/images/sam.jpg|note:Sam on my rooftop in at the northern tip of Manhattan, filtered through early-era Instagram, 2016.}}, {{the ponds of Hampstead Heath|image:/images/hampstead-heath.jpg|note:A large, ancient heath in north London, known for its wild swimming ponds and panoramic city views.}}, {{the rambling hills of the lower Jura|image:/images/global-cities.png|note:A sub-Alpine mountain range stretching along the French-Swiss border near Geneva.}} that were a run away from my apartment.`,

  `Going outside has always felt more like a spiritual practice than an adventure, something I could never quite explain even to my sportiest of friends. I've always needed my dosage on a regular basis, and I could never really understand why until recently.`,
