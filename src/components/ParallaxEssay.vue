...
const rawParagraphs = [
  ...
  `Of course, I was too young to understand the shifts in selfhood that migration creates as a child born and raised in the American empire. Instead, I loved the stories themselves, and the illustrations that showed me another way of seeing the world outside of {{high-rise Chicago skyscrapers|image:/images/chicago.jpg}} or {{midwestern pay-to-pick farms|image:/images/larriland.jpg}}. The world of the book (and therefore the world of my mother's homeland) was inhabited by talking tigers and sea spirits, by brothers and sisters that became the sun and the moon, of gods descending to earth through the mountains. One of my favorites was about the tiger and the bear.`,
