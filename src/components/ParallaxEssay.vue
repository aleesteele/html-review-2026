...
const rawParagraphs = [
  ...
  `The Baekdudaegan is a mountain range that is as much a product of mythology as it is of geology, roughly 1,500 kilometers across the Korean peninsula. It starts at Baekdusan, an active volcano that sits on the border of what is now known as the Democratic Republic of Korea (North Korea) and China. After curving down the peninsula, the range ends at {{Hallasan|image:/images/hallasan.png|note:한라산 — A shield volcano and the highest peak in South Korea (1,950m), located on Jeju Island.}} on Jeju Island, a dormant volcano that sits on what's known as the "Hawaii of Korea", the home of the legendary {{hanyeo|note:해녀 — Female free-divers of Jeju Island, who were recognized by UNESCO as intangible cultural heritage in 2016. The women dive without oxygen tanks to harvest seafood, primarily abalone, conch, sea urchins, octopus, sea cucumbers, and types of seaweed.}}. These two mountains sit at the heart of Korean mythology, with Baekdusan the father and Hallasan the mother cradling both sides of the peninsula in some kind of protective embrace.`,
    ...
    <div class="scroll-content">
      ...
      <div class="title-spacer">
        <div class="title-track">
          ...
          <span class="title-subtitle">Designed and written by <a href="https://aleesteele.com" target="_blank" rel="noopener noreferrer" class="title-link">Anne Lee Steele</a> for <a href="https://thehtml.review/05/" target="_blank" rel="noopener noreferrer" class="title-link">The HTML review #05</a></span>
          </h1>
        </div>
      </div>
