...
const rawParagraphs = [
  ...
  `For me, these stories were magical illustrations of the world that once was, and it imbued nature with a magic I only started to understand when I started spending more time in mountains myself: first as a {{hiker in the Adirondacks and the Cascades|note:Two major mountain ranges in the northeastern and northwestern United States, popular with long-distance hikers.}}, then as a {{researcher in the Himalayas|note:Anne worked as a researcher in Bhutan, studying in the eastern Himalayan region.}}, later a {{skier and mountaineer in the Alps|note:Europe's highest mountain range, spanning eight countries from France to Slovenia.}}.`,
